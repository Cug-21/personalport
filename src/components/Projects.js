...
function Projects() {
    ...
    const projects = [
      { name: 'Ease OF Finance', link: 'https://www.easeoffinance.net/', description: 'Ease Of Finance is an innovative financial tool designed to simplify the complexities of finance. Utilizing advanced AI and NLP (Natural Language Processing) systems, it analyzes live news articles and up-to-date financial data. This enables the platform to deliver AI-driven financial analysis, along with comprehensive Excel report generation. Additionally, Ease Of Finance features a unique Congress Trade Tracker, offering insightful perspectives on congressional trading activities. This tool is ideal for those seeking intelligent, data-driven financial insights', status: 'completed'},
      { name: 'UnCensored Chess', link: 'http://elasticbeanstalk-us-west-2-764566195978.s3-website-us-west-2.amazonaws.com/my-chess-app/', description: 'A chess app where users can play one another along with Ai to chess, we all know that a super computer would beat any chess player but I aim to develop an AI chess bot who can play and beat the best players in the world while running on a mere laptop :). Currently on Mock1. Deployed through elastic beanstalk.', status: 'completed'},
